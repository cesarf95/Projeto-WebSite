...
// Captura a função para o controle do menu igual ao sgai.php
$funcao = isset($_SESSION['funcao']) ? $_SESSION['funcao'] : 'Operador';
...
<head>
    ...
    <title>Setores - TechMetal</title>
    <link rel="icon" href="imagens/energy-source.png" type="image/png">
...
<body>
    ...
    <div class="w-full flex justify-center my-12">
        <nav class="relative mb-10 group w-full max-w-[900px] h-48 flex items-center justify-center">
            <a href="sgai.php" title="Página Inicial"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-bold">NOVO SETOR</h5>
                ...
                <div class="modal-body">
                    <form action="salvar_setor.php" method="POST">
                        ...
                        <button class="btn btn-success w-100 fw-bold">CADASTRAR SETOR</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title fw-bold text-dark">EDITAR SETOR</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form action="editar_setor.php" method="POST">
                        ...
                        <label class="form-label fw-bold">DESCRIÇÃO</label>
                        <textarea name="descricao" id="edit_descricao" class="form-control mb-3" rows="4"></textarea>

                        <button class="btn btn-warning w-100 fw-bold">ATUALIZAR SETOR</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title fw-bold">EXCLUIR SETOR</h5>
                    <button class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body text-center">
                    <h5>Deseja realmente excluir o setor:</h5>
                    <h4 id="nome_setor_excluir" class="fw-bold text-danger mt-3"></h4>

                    <form action="excluir_setor.php" method="POST">
                        <input type="hidden" name="id" id="delete_id">
                        <button class="btn btn-danger fw-bold mt-4">EXCLUIR SETOR</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    modalExcluir.addEventListener('show.bs.modal', function(event) {
        ...
        document.getElementById('nome_setor_excluir').innerHTML = button.getAttribute('data-nome');
    });
    </script>

...
$funcao_logada = $_SESSION['funcao'] ?? '';

// VerificaÃ§Ã£o de privilÃ©gios idÃªntica ao usuarios.php
if ($funcao_logada != 'Administrador' && $funcao_logada != 'Gerencia') {
    echo "<script>
        alert('Erro no sistema: Acesso Restrito.');
...
<head>
    ...
    <title>Operadores - TechMetal</title>
    <link rel="icon" href="imagens/employees.png" type="image/png">
    ...
    tailwind.config = {
        corePlugins: {
            preflight: false, // CorreÃ§Ã£o do conflito: Impede o Tailwind de quebrar o Bootstrap
        }
    }
    </script>
...
<body>
    ...
    <div class="w-full flex justify-center my-12">
        <nav class="relative mb-10 group w-full max-w-[900px] h-48 flex items-center justify-center">
            ...
            <div
                ...
                <?php if ($funcao_logada == 'Administrador'): ?>
                <a href="usuarios.php"
    ...
    <div class="text-center my-4">
        <button type="button" class="btn btn-success fw-bold text-white shadow-sm" data-bs-toggle="modal"
            data-bs-target="#modalCadastrarOperador">
            ...
            <div class="col-md-11">
                <div class="card shadow border-2">
                    <div class="card-header bg-dark text-white text-center">
                        <b class="letter-spacing-1">OPERADORES DO SISTEMA</b>
                    </div>

                    <div class="card-body">
                        <?php
                        $sql = "SELECT id, nome, funcao, genero, data_entrada, cpf FROM operadores ORDER BY nome ASC";
                        ...
                        if (count($dados) > 0) {
                            ...
                            foreach ($dados as $item) {
                                ...
                                $data_entrada = htmlspecialchars($item['data_entrada']);
                                $cpf = htmlspecialchars($item['cpf']);

                                // SeguranÃ§a contra aspas quebradas que congelavam a aÃ§Ã£o
                                $nome_seguro = addslashes($nome_user);
                                ...
                                <tr>
                                    ...
                                    <td class='acoes text-center'>
                                        ...
                                        <a href='excluir_operadores.php?id={$id}'
                                           onclick=\"return confirm('Deseja excluir este Operador?')\"
                                           title='Excluir'>
                                           ❌
                                        </a>
                                    </td>
    ...
    <div class="modal fade" id="modalCadastrarOperador" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title fw-bold">NOVO OPERADOR</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="cadastro_operadores.php" method="POST">
                        ...
                        <select name="funcao" class="form-select mb-2">
                            <option value="Almoxarife">Almoxarife</option>
                            <option value="Operador">Operador</option>
                            <option value="Conferente">Conferente</option>
                            <option value="Encarregado">Operador</option>
                        ...
                        <input type="date" name="data_entrada" class="form-control mb-2" required>



                        <button type="submit" class="btn btn-success w-100 fw-bold text-white">CADASTRAR
                            OPERADOR</button>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-warning">
                    <h5 class="modal-title fw-bold text-dark">EDITAR OPERADOR</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="editar_operadores.php" method="POST">
                        ...
                        <label class="form-label fw-bold">FUNÇÃO</label>
                        <select name="funcao" id="edit_funcao" class="form-select mb-2">
                            <option value="Almoxarife">Almoxarife</option>
                            <option value="Operador">Operador</option>
                            <option value="Operador">Conferente</option>
                            <option value="Supervisor">Supervisor</option>
                        ...
                        <button type="submit" class="btn btn-warning w-100 fw-bold text-dark">ATUALIZAR
                            OPERADOR</button>
                    </form>
                </div>
            </div>
    ...
    modalEditar.addEventListener('show.bs.modal', function(event) {
        ...
        document.getElementById('edit_data_entrada').value = button.getAttribute('data-data_entrada') || '';
    });
    </script>
    </body>
